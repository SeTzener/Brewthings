...
private fun CompositionBar(label: String, percentage: Float, color: Color) {
    Column {
        ...
        Text(
            text = stringResource(R.string.brew_composition_percent_format, percentage),
...
private fun Float.toSweetnessLevelDescription(): String {
    val level = when {
        this <= 0.03f -> stringResource(R.string.brew_composition_sweetness_level_0_3)
        this <= 0.05f -> stringResource(R.string.brew_composition_sweetness_level_3_5)
        this <= 0.1f -> stringResource(R.string.brew_composition_sweetness_level_5_10)
        this <= 0.15f -> stringResource(R.string.brew_composition_sweetness_level_10_15)
        this <= 0.2f -> stringResource(R.string.brew_composition_sweetness_level_15_20)
        this <= 0.3f -> stringResource(R.string.brew_composition_sweetness_level_20_30)
        this <= 0.4f -> stringResource(R.string.brew_composition_sweetness_level_30_40)
        this <= 0.5f -> stringResource(R.string.brew_composition_sweetness_level_40_50)
        this <= 0.6f -> stringResource(R.string.brew_composition_sweetness_level_50_60)
        this <= 0.7f -> stringResource(R.string.brew_composition_sweetness_level_60_70)
        this <= 0.8f -> stringResource(R.string.brew_composition_sweetness_level_70_80)
        this <= 0.9f -> stringResource(R.string.brew_composition_sweetness_level_80_90)
